...
final class InterpreterData implements Serializable, DebuggableScript
{
    ...
    //OwnCode
    private LinkedList<VariablenListenElement> varStorage = new LinkedList<VariablenListenElement>();
    
    public void setvarStorage(LinkedList<VariablenListenElement> v){
    	this.varStorage = v;
    }
    
    public LinkedList<VariablenListenElement> getvarStorage(){
